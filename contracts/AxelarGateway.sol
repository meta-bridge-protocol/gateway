...
contract AxelarGateway is ReentrancyGuard, AccessControlEnumerable, Pausable {
	...
	event Deposited(address indexed user, uint16 tokenId, uint256 realTokenAmount, uint256 axlTokenAmount);
	...
	event Withdrawn(address indexed user, uint16 tokenId, uint256 realTokenAmount, uint256 axlTokenAmount);
	...
	function setTokenActivation(uint16 tokenId, bool active) external onlyRole(OPERATOR_ROLE) {
		require(tokenId != 0 && tokens[tokenId].id == tokenId, "AxelarGateway: INVALID_TOKEN");
	...
	function swapToReal(uint16 tokenId, uint256 amount) external nonReentrant whenNotPaused {
	...
	function swapToAxl(uint16 tokenId, uint256 amount) external nonReentrant whenNotPaused {
	...
	function swapToRealTo(uint16 tokenId, uint256 amount, address to) external nonReentrant whenNotPaused {
	...
	function swapToAxlTo(uint16 tokenId, uint256 amount, address to) external nonReentrant whenNotPaused {
	...
	function _swap(uint16 tokenId, uint256 amount, address to, SwapType type_) internal {
	...
	function deposit(uint16 tokenId, uint256 realTokenAmount, uint256 axlTokenAmount) external nonReentrant whenNotPaused {
	...
	function withdraw(uint16 tokenId, uint256 realTokenAmount, uint256 axlTokenAmount) external nonReentrant whenNotPaused {
